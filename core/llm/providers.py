...
class OpenAIProvider(LLMProvider):
    ...
    def __init__(self, api_key: str = None, model: str = "gpt-4", max_tokens: Optional[int] = None, temperature: float = 0.7):
...
class ClaudeProvider(LLMProvider):
    ...
    def __init__(self, api_key: str = None, model: str = "claude-3-sonnet-20240229", max_tokens: Optional[int] = None, temperature: float = 0.7):
...
class GrokProvider(LLMProvider):
    ...
    def __init__(self, api_key: str = None, model: str = "grok-beta", max_tokens: Optional[int] = None, temperature: float = 0.7):
...
class GeminiProvider(LLMProvider):
    ...
    def __init__(self, api_key: str = None, model: str = "gemini-pro", max_tokens: Optional[int] = None, temperature: float = 0.7):
...
class OllamaProvider(LLMProvider):
    ...
    def __init__(self, api_key: str = None, model: str = "llama2", base_url: str = "http://localhost:11434", 
